...
class Report:
    def __init__(self, report_definition, data, is_test_data=False, additional_fonts=None,
        ...
        self.additional_fonts = [
            dict(
                value='comicsans',
                filename='/openimis-be/openIMIS/fonts/COMICSANS.TTF',
                bold_filename='/openimis-be/openIMIS/fonts/COMICSANSBOLD.TTF',
                italic_filename='/openimis-be/openIMIS/fonts/COMICSANSITALIC.TTF',
                bold_italic_filename='/openimis-be/openIMIS/fonts/COMICSANSBOLDITALIC.TTF'
            ),
            dict(
                value='dejavusans',
            ...
            dict(
                value='times',
                filename='/openimis-be/openIMIS/fonts/Times_New_Roman.ttf',
